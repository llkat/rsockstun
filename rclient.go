...
func connectForSocks(address string, proxy string) error {
	...
	//sending magic bytes 32 67 31 ee af 44 22 34 30 99 91 12 43 ee 43 87

	magicbytes := []byte{0x32,0x67,0x31,0xee,0xaf,0x44,0x22,0x34,0x30,0x99,0x91,0x12,0x43,0xee,0x43,0x87,,
		0x32,0x67,0x31,0xee,0xaf,0x44,0x22,0x34,0x30,0x99,0x91,0x12,0x43,0xee,0x43,0x87,
		0x32,0x67,0x31,0xee,0xaf,0x44,0x22,0x34,0x30,0x99,0x91,0x12,0x43,0xee,0x43,0x87,
		0x32,0x67,0x31,0xee,0xaf,0x44,0x22,0x34,0x30,0x99,0x91,0x12,0x43,0xee,0x43,0x87,}
	//log.Printf("Sending magic bytes: %v",magicbytes)
